...
# ref: app/twisted/internet/tcp.py, Port.doRead
#
# Twisted using IOCP on Windows:
# - logs and ignores all errors
# ref: app/twisted/internet/iocpreactor/tcp.py, Port.handleAccept
#
# Tornado:
...
# (ref: app/unix/stream.c:uv__server_io, uv__emfile_trick)
#
# libuv on Windows:
# app/win/tcp.c:uv_tcp_queue_accept
#   this calls AcceptEx, and then arranges to call:
# app/win/tcp.c:uv_process_tcp_accept_req
