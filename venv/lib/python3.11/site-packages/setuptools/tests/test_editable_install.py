...
def test_editable_with_pyproject(tmp_path, venv, files, editable_opts):
    ...
    (project / "app/mypkg/data.txt").write_text("foobar", encoding="utf-8")
    (project / "app/mypkg/mod.py").write_text("x = 42", encoding="utf-8")
...
class TestFinderTemplate:
    ...
    def test_combine_namespaces_nested(self, tmp_path):
        ...
        files = {
            "app": {"my_package": {"my_module.py": "a = 13"}},
        ...
        with contexts.save_paths(), contexts.save_sys_modules():
            ...
            expected = str((tmp_path / "app/my_package/my_module.py").resolve())
    ...
    def test_intermediate_packages(self, tmp_path):
        ...
        mapping = {"mypkg": str(tmp_path / "app/mypkg")}
        template = _finder_template(str(uuid4()), mapping, {})
...
class TestLinkTree:
    FILES = deepcopy(TestOverallBehaviour.EXAMPLES["app-layout"])
    ...
    FILES["app"]["mypkg"]["resource.not_in_manifest"] = "abc"
    ...
    def test_generated_tree(self, tmp_path):
        ...
        with _Path(tmp_path):
            ...
            expected = tmp_path / "app/mypkg/mod1.py"
