...
class TestMetadata:
    ...
    def test_version_with_package_dir_simple(self, tmpdir):
        fake_env(
            ...
            'package_dir =\n'
            '    = app\n',
            package_path='app/fake_package_simple',
        )
    ...
    def test_version_with_package_dir_complex(self, tmpdir):
        fake_env(
            ...
            '[options]\n'
            'package_dir =\n'
            '    fake_package_complex = app/fake_dir\n',
            package_path='app/fake_dir',
        )
...
class TestOptions:
    def test_basic(self, tmpdir):
        ...
        with deprec, get_dist(tmpdir) as dist:
            ...
            assert dist.package_dir == {'': 'app', 'b': 'c'}
    ...
    def test_cmdclass(self, tmpdir):
        module_path = Path(tmpdir, "app/custom_build.py")  # auto discovery for app
