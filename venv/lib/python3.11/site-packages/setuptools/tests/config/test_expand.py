...
class TestReadAttr:
    ...
    def test_import_order(self, tmp_path):
        ...
        """
        files = {
            "app/pkg/__init__.py": "from .main import func\nfrom .about import version",
            "app/pkg/scraper.py": "import super_complicated_dep\ndef func(): return 42",
            "app/pkg/about.py": "version = '42'",
        }
        write_files(files, tmp_path)
...
@pytest.mark.parametrize(
    ...
    [
        ({"": "app"}, "app/pkg/scraper.py", "pkg.main", 42),
        ({"pkg": "lib"}, "lib/scraper.py", "pkg.main", 13),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["app/pkg1/__init__.py", "app/pkg1/other.py"], ["app"], {"": "app"}),
        (["app/pkg1/__init__.py", "app/pkg2/__init__.py"], ["app"], {"": "app"}),
        (
        ...
        (
            ["app/pkg1/__init__.py", "pkg2/__init__.py"],
            ["app", "."],
            {"pkg1": "app/pkg1"},
        ),
    ],
