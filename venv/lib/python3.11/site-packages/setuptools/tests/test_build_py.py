...
def test_get_outputs(tmpdir_cwd):
    ...
    assert mapping == {
        f"{build_lib}/mypkg/__init__.py": "app/mypkg/__init__.py",
        f"{build_lib}/mypkg/resource_file.txt": "app/mypkg/resource_file.txt",
        f"{build_lib}/mypkg/sub1/__init__.py": "app/mypkg/sub1/__init__.py",
        f"{build_lib}/mypkg/sub1/mod1.py": "app/mypkg/sub1/mod1.py",
        f"{build_lib}/mypkg/sub2/mod2.py": "app/mypkg/_sub2/mod2.py",
