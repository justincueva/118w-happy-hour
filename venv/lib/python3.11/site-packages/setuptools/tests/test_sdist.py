...
class TestSdistTest:
    ...
    def test_exclude_dev_only_cache_folders(self, source_dir):
        included = {
            ...
            "app/.nox/py/lib/python3.12/site-packages/bar-2.dist-info/COPYING.txt": "",
    ...
    def test_add_files_referenced_by_config_directives(self, source_dir, config):
        ...
        (source_dir / 'app/VERSION.txt').write_text("0.42", encoding="utf-8")
        ...
        assert (
            'app/VERSION.txt' in cmd.filelist.files
            or 'app\\VERSION.txt' in cmd.filelist.files
        )
