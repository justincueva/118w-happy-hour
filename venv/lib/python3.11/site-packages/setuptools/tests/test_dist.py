...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "my_pkg",
            None,
            ["app/my_pkg/__init__.py", "app/my_pkg2/__init__.py"],
            ["my_pkg", "my_pkg2"],
        ),
        (
            "my_pkg",
...
def test_dist_default_packages(
    ...
    # Find `packages` either corresponding to dist_name or inside app
    dist = Distribution(attrs)
    dist.set_defaults()
    assert not dist.py_modules
    assert not dist.py_modules
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("my_pkg", None, ["app/my_pkg/__init__.py", "app/my_pkg/nested/__init__.py"]),
        (
            "my_pkg",
        ...
        ("UNKNOWN", None, ["app/mod1.py", "app/mod2.py"]),
        ("UNKNOWN", None, ["app/pkg1/__ini__.py", "app/pkg2/__init__.py"]),
    ],
)
